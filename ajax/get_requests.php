...
if (count($reqs)>0) { // exista comenzi pentru utilizatorul conectat
    ...
    $html .= '<th style="width:15%;" class="sortable" onclick="sort(1);" ><div style="float: left;width:80%;text-align: center;">Nr. comandă</div>'.$sort_indicator[1].'</th>';
    $html .= '<th style="width:15%;" class="sortable" onclick="sort(2);" ><div style="float: left;width:80%;text-align: center;">Data plasării</div>'.$sort_indicator[2].'</th>';
    $html .= '<th style="width:15%;" class="sortable" onclick="sort(3);" ><div style="float: left;width:80%;text-align: center;">Data terminării</div>'.$sort_indicator[3].'</th>';
    $html .= '<th style="width:12%;" class="sortable" onclick="sort(4);" ><div style="float: left;width:80%;text-align: center;">Nr. poziții</div>'.$sort_indicator[4].'</th>';
    $html .= '<th style="width:12%;" class="sortable" onclick="sort(5);" ><div style="float: left;width:80%;text-align: center;">Nr. articole</div>'.$sort_indicator[5].'</th>';
