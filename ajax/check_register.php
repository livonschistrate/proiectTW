...
if(count($deja_user)==0){
    ...
    (firstname, lastname, email, telefon,password,id_role,is_validated,is_deleted,is_enabled,register_date)
    VALUES ('".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['telefon']."','".MD5($_POST['password'])."',1,0,0,1,NOW())";
    $db -> exec($sql);
